	...
	if($_SERVER['REQUEST_METHOD'] === "POST"){
		...
		if(!$flag){
			...
			if($a){
				...
				echo "<p>Forget Password?</p>";
				echo "<a href=updatenursepass.php>Click here for Sign up!</a>";
		...
		else
		{
			...
			header("Location: http://127.0.0.1/Project/dashnurse.php");
...
<body>
	...
	<form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" novalidate>
		<fieldset>
			...
			<a href="regnurse.php">Click here for Sign up!</a>
